                    ...
                    @unless($this->hideHeader)
                        ...
                        <div class="table-row bg-blue-100 divide-x divide-blue-200">
                            @foreach ($this->columns as $index => $column)
                                ...
                                @elseif($column['type'] === 'checkbox')
                                    <div
                                        class="flex flex-col items-center h-full px-6 py-5 space-y-2 overflow-hidden text-xs font-medium leading-4 tracking-wider text-left text-gray-700 uppercase align-top bg-blue-100 border-b border-gray-200 focus:outline-none">
                                        <div>SELECT ALL</div>
                                        <div>
