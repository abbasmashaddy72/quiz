    ...
    <div class="sidebar-body data-scrollbar">
        <ul class="iq-main-menu dark:bg-dark-card" x-data="sidebar">
            ...
            <x-nav-link :href="route('user.index')" :active="request()->routeIs('user.index*')">
                ...
                <x-slot name="nav_title">{{ __('Users') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('role.index')" :active="request()->routeIs('role.index*')">
                ...
                <x-slot name="nav_title">{{ __('Roles') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('topic.index')" :active="request()->routeIs('topic.index*')">
                ...
                <x-slot name="nav_title">{{ __('Topics') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('image.index')" :active="request()->routeIs('image.index*')">
                ...
                <x-slot name="nav_title">{{ __('Images') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('question.index')" :active="request()->routeIs('question.index*')">
                ...
                <x-slot name="nav_title">{{ __('Questions') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('questions_option.index')" :active="request()->routeIs('questions_option.index*')">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                            d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <x-slot name="nav_title">{{ __('Question Options') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('result.index')" :active="request()->routeIs('result.index*')">
                ...
                <x-slot name="nav_title">{{ __('Results') }}</x-slot>
            </x-nav-link>
        </ul>
    </div>
